...
class Atri:
	def __init__(self, state: Any):
		...
		self.banner_left = state["banner_left"]
	...
	def banner_left(self):
		self._getter_access_tracker["banner_left"] = {}
		return self._banner_left
	@banner_left.setter
	def banner_left(self, new_state):
		self._setter_access_tracker["banner_left"] = {}
		global default_state
		self._banner_left = Flex(new_state, default_state["banner_left"])
